      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Founder, Corner Stone Design & Media
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-lg leading-relaxed text-gray-700 mt-4" style={{ lineHeight: '1.8' }}>
            My focus is simple building brands that people recognise and remember.
          </p>
          <p className="text-lg leading-relaxed text-gray-700 mt-4" style={{ lineHeight: '1.8' }}>
            Because in today's world, the brands that stand out are the ones that grow.
          </p>
        </motion.div>
      </div>
    </section>
